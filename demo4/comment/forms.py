...
class CommentForm(forms.Form):
    ...
    url=forms.URLField(label="输入主页",widget=forms.URLInput(attrs={"id":"id_url"}))
    comment=forms.CharField(required=True,label="输入评论",widget=forms.TextInput(attrs={"id":"id_comment"}))
